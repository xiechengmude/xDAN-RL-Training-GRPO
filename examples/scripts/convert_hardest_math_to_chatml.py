...
Dataset from 'xDAN2099/xDAN-Hardest-level-math-collection' with format:
{
...
def main():
    ...
    parser.add_argument('--output', type=str, default='examples/data/xDAN-Hardest-level-math-collection_chatml_rl.json',
                      help='Output file name')
    args = parser.parse_args()
    
    dataset = load_dataset("xDAN2099/xDAN-Hardest-level-math-collection", split="train")
