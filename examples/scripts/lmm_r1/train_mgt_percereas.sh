...
export DATASET_PATH="./data/MathV360k/train_filter50.jsonl"  # Path to your dataset
export PRETRAIN_MODEL_PATH="./checkpoints/lmm-r1-mgt-geo/"  # Path to pretrained model
...
echo "================================================================"
echo "LMM-R1 MGT-PerceReason Training"
echo "================================================================"
